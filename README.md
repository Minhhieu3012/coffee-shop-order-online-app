...
- Chức năng giỏ hàng (Cart), đặt hàng (Order), lịch sử mua hàng
- Nhận thông báo đơn hàng (qua FCM)
- Quản lý thông tin cá nhân (profile, địa chỉ giao hàng)
...
- Giao diện thân thiện, sẵn sàng demo
